...
import DayfourTile from '../components/DayfourTile'

class DayfourContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pictureArray: []
  ...
  render() {
    ...
    let dayfourTiles = this.state.pictureArray.map(picture => {
      return(
        <DayfourTile
          key={picture.id}
          id={picture.id}
...
export default DayfourContainer;
