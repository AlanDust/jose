...
import DaysevenTile from '../components/DaysevenTile'

class DaysevenContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pictureArray: []
  ...
  render() {
    ...
    let daysevenTiles = this.state.pictureArray.map(picture => {
      return(
        <DaysevenTile
          key={picture.id}
          id={picture.id}
...
export default DaysevenContainer;
