...
import DayeightTile from '../components/DayeightTile'

class DayeightContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pictureArray: []
  ...
  render() {
    ...
    let dayeightTiles = this.state.pictureArray.map(picture => {
      return(
        <DayeightTile
          key={picture.id}
          id={picture.id}
...
export default DayeightContainer;
