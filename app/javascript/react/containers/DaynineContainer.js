...
import DaynineTile from '../components/DaynineTile'

class DaynineContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pictureArray: []
  ...
  render() {
    ...
    let daynineTiles = this.state.pictureArray.map(picture => {
      return(
        <DaynineTile
          key={picture.id}
          id={picture.id}
...
export default DaynineContainer;
